...
- Source URL: `git+https://github.com/damatter/inventree-customer-pricing.git@0.3.1`
- Version: leave blank (the release is pinned in the source URL)

The equivalent `plugins.txt` entry is:

```text
inventree-customer-pricing @ git+https://github.com/damatter/inventree-customer-pricing.git@0.3.1
```
